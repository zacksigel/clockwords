  ...
  return (
    <div className="overlay">
      ...
      <div className="overlay-content">
        ...
        <div className='overlay-content-instructions demo-note'>This is a demo version with three words hardcoded into the frontend. The game will randomly choose one of the words when you refresh the page.</div>
      </div>
    </div>
  );
};
